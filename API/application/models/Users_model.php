...
class Users_model extends Main_model
{
    ...
    public $mail_app_name = 'Sabujsathi';
	public $mail_address = 'Mirhat, Burdwan,713122';
	public $mail_email = 'hello@sabujsathiagro.com';
	public $mail_phone = '+36 202574119*';
    ...
    public function sendBulk($to_address,$message,$subject){
        ...
        $this->email->clear();
        $this->email->from('hello@mesdtech.com');
        $this->email->reply_to('hello@mesdtech.com');
